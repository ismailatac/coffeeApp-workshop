...
public class MNVKPSPublicSoap
{
    ...
    public MNVKPSPublicSoap(){}

    public MNVKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public MNVKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        MNVExtendedSoapSerializationEnvelope envelope= new MNVExtendedSoapSerializationEnvelope(MNVExtendedSoapSerializationEnvelope.VER11);
