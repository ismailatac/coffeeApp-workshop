...
class MNVSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class MNVExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(MNVDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new MNVStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static MNVDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static MNVDateTimeConverter dateTimeConverter = new MNVStandardDateTimeConverter();

    public MNVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public MNVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new MNVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=MNVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,MNVExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=MNVHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
